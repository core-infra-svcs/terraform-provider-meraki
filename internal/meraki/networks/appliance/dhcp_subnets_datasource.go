...
type DevicesApplianceDhcpSubnetsDataSourceModelList struct {
	...
	VlanId    jsontypes2.Int64  `tfsdk:"vlan_id" json:"vlanId"`
	UsedCount jsontypes2.Int64  `tfsdk:"used_count" json:"usedCount"`
	FreeCount jsontypes2.Int64  `tfsdk:"free_count" json:"freeCount"`
}
