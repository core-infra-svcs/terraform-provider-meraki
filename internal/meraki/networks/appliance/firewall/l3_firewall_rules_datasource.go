...
var _ datasource.DataSource = &L3FirewallRulesDataSource{}

func NewNetworksApplianceFirewallL3FirewallRulesDataSource() datasource.DataSource {
	return &L3FirewallRulesDataSource{}
}

// L3FirewallRulesDataSource defines the data source implementation.
type L3FirewallRulesDataSource struct {
	client *openApiClient.APIClient
}

func (d *L3FirewallRulesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_networks_appliance_firewall_l3_firewall_rules"
}

func (d *L3FirewallRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *L3FirewallRulesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *L3FirewallRulesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
