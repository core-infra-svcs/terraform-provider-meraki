...
func RadiusServersState(ctx context.Context, plan NetworksWirelessSsidResourceModel, httpResp map[string]interface{}) (types.List, diag.Diagnostics) {
	var diags diag.Diagnostics
	var radiusServers []RadiusServer
...
func RadiusAccountingServersState(ctx context.Context, plan NetworksWirelessSsidResourceModel, httpResp map[string]interface{}) (types.List, diag.Diagnostics) {
	var diags diag.Diagnostics
	var radiusServers []RadiusServer
