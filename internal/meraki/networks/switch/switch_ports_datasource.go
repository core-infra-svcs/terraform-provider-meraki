...
func (d *DevicesSwitchPortsStatusesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	for _, switchData := range inlineResp {
		...
		devicesSwitchPortData.Name = jsontypes2.StringValue(switchData.GetName())
		devicesSwitchPortData.PortId = jsontypes2.StringValue(switchData.GetPortId())
		devicesSwitchPortData.Enabled = jsontypes2.BoolValue(switchData.GetEnabled())
		devicesSwitchPortData.PoeEnabled = jsontypes2.BoolValue(switchData.GetPoeEnabled())
		devicesSwitchPortData.Type = jsontypes2.StringValue(switchData.GetType())
		devicesSwitchPortData.Vlan = jsontypes2.Int64Value(int64(switchData.GetVlan()))
		devicesSwitchPortData.VoiceVlan = jsontypes2.Int64Value(int64(switchData.GetVoiceVlan()))
		devicesSwitchPortData.AllowedVlans = jsontypes2.StringValue(switchData.GetAllowedVlans())
		devicesSwitchPortData.IsolationEnabled = jsontypes2.BoolValue(switchData.GetIsolationEnabled())
		devicesSwitchPortData.RstpEnabled = jsontypes2.BoolValue(switchData.GetRstpEnabled())
		devicesSwitchPortData.StpGuard = jsontypes2.StringValue(switchData.GetStpGuard())
		devicesSwitchPortData.AccessPolicyNumber = jsontypes2.Int64Value(int64(switchData.GetAccessPolicyNumber()))
		devicesSwitchPortData.AccessPolicyType = jsontypes2.StringValue(switchData.GetAccessPolicyType())
		devicesSwitchPortData.LinkNegotiation = jsontypes2.StringValue(switchData.GetLinkNegotiation())
		devicesSwitchPortData.PortScheduleId = jsontypes2.StringValue(switchData.GetPortScheduleId())
		devicesSwitchPortData.Udld = jsontypes2.StringValue(switchData.GetUdld())
		devicesSwitchPortData.StickyMacWhitelistLimit = jsontypes2.Int64Value(int64(switchData.GetStickyMacAllowListLimit()))
		devicesSwitchPortData.StormControlEnabled = jsontypes2.BoolValue(switchData.GetStormControlEnabled())
		devicesSwitchPortData.AdaptivePolicyGroupId = jsontypes2.StringValue(switchData.GetAdaptivePolicyGroupId())
		devicesSwitchPortData.PeerSgtCapable = jsontypes2.BoolValue(switchData.GetPeerSgtCapable())
		devicesSwitchPortData.FlexibleStackingEnabled = jsontypes2.BoolValue(switchData.GetFlexibleStackingEnabled())
		devicesSwitchPortData.DaiTrusted = jsontypes2.BoolValue(switchData.GetDaiTrusted())
		devicesSwitchPortData.Profile.Enabled = jsontypes2.BoolValue(switchData.Profile.GetEnabled())
		devicesSwitchPortData.Profile.Id = jsontypes2.StringValue(switchData.Profile.GetId())
		devicesSwitchPortData.Profile.Iname = jsontypes2.StringValue(switchData.Profile.GetIname())
		for _, attribute := range switchData.GetStickyMacAllowList() {
			devicesSwitchPortData.StickyMacWhitelist = append(devicesSwitchPortData.StickyMacWhitelist, jsontypes2.StringValue(attribute))
		}
		for _, attribute := range switchData.GetTags() {
			devicesSwitchPortData.Tags = append(devicesSwitchPortData.Tags, jsontypes2.StringValue(attribute))
		}
		for _, attribute := range switchData.GetMacAllowList() {
			devicesSwitchPortData.MacWhitelist = append(devicesSwitchPortData.MacWhitelist, jsontypes2.StringValue(attribute))
		}
