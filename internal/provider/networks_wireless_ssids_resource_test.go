		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_servers.0.host", "8.8.8.8"),
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_servers.0.port", "1812"),
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_servers.1.host", "4.4.4.4"),
					...
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_accounting_servers.0.host", "8.8.8.8"),
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_accounting_servers.0.port", "1813"),
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_accounting_servers.1.host", "4.4.4.4"),
					...
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "radius_authentication_nas_id", "nas-id"),
					...
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "gre.concentrator.host", "1.2.3.4"),
					...
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "dns_rewrite.dns_custom_nameservers.0", "8.8.4.4"),
					resource.TestCheckResourceAttr("meraki_networks_wireless_ssids.test", "dns_rewrite.dns_custom_nameservers.1", "8.8.8.8"),
...
resource "meraki_networks_wireless_ssids" "test" {
    ...
    radius_authentication_nas_id = "nas-id"
	...
	dns_rewrite = {
        enabled = true
        dns_custom_nameservers = ["8.8.4.4", "8.8.8.8"]
    }
	speed_burst = {
        enabled = true
    }
