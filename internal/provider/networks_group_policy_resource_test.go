				...
				Check: func(s *terraform.State) error {
					...
					for i := 1; i <= policies; i++ {
						...
						checks = append(checks,
							...
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.1.policy", "deny"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.1.type", "ipRange"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.1.value", "10.11.12.00/24"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.2.policy", "deny"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.2.type", "ipRange"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.2.value", "10.11.12.00/24:5555"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.3.policy", "deny"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.3.type", "port"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.l7_firewall_rules.3.value", "23"),
							...
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.traffic_shaping_rules.0.definitions.0.type", "host"),
							resource.TestCheckResourceAttr(resourceName, "firewall_and_traffic_shaping.traffic_shaping_rules.0.definitions.0.value", "google.com"),
