	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"wan1_wan_enabled": schema.StringAttribute{
				MarkdownDescription: "wan1 wan enabled",
				Optional:            true,
				CustomType:          jsontypes.StringType,
			},
			"wan1_using_static_ip": schema.BoolAttribute{
				MarkdownDescription: "wan1 using static ip",
				Optional:            true,
				CustomType:          jsontypes.BoolType,
			},
			"wan1_vlan": schema.Int64Attribute{
				MarkdownDescription: "wan1 vlan",
				Optional:            true,
				CustomType:          jsontypes.Int64Type,
			},
			"wan1_static_ip": schema.StringAttribute{
				MarkdownDescription: "wan1 static ip",
				Optional:            true,
				CustomType:          jsontypes.StringType,
			},
			"wan1_static_subnet_mask": schema.StringAttribute{
				MarkdownDescription: "wan1 static subnet mask",
				Optional:            true,
				CustomType:          jsontypes.StringType,
			},
			"wan1_static_gateway_ip": schema.StringAttribute{
				MarkdownDescription: "wan1 static gateway ip",
				Optional:            true,
				CustomType:          jsontypes.StringType,
			},
			"wan1_static_dns": schema.ListNestedAttribute{
				MarkdownDescription: "wan1 static dns",
				Optional:            true,
			},
			"wan2_wan_enabled": schema.StringAttribute{
				MarkdownDescription: "wan2 wan enabled",
				Optional:            true,
				CustomType:          jsontypes.StringType,
			},
			"wan2_using_static_ip": schema.BoolAttribute{
				MarkdownDescription: "wan2 using static ip",
				Optional:            true,
				CustomType:          jsontypes.BoolType,
			},
			"wan2_vlan": schema.Int64Attribute{
				MarkdownDescription: "wan2 vlan",
				Optional:            true,
				CustomType:          jsontypes.Int64Type,
			},
		},
