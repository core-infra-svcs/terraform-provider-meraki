		...
		Steps: []resource.TestStep{
			...
			// Create test Organization
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("meraki_organization.test", "name", "test-acc-meraki-organizations-snmp-settings"),
				),
			},
...
const testAccNetworkSnmpSettingsResourceConfigCreateOrganization = `
 resource "meraki_organization" "test" {
 	name = "test-acc-meraki-organizations-snmp-settings"
 	api_enabled = true
 } 
 `
