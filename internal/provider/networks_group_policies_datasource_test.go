	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Read test network group policies
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.#", "1"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.name", "testpolicy"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.splash_auth_settings", "network default"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.bandwidth.settings", "custom"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.bandwidth.bandwidth_limits.limit_up", "100000"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.bandwidth.bandwidth_limits.limit_down", "100000"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.vlan_tagging.settings", "custom"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.vlan_tagging.vlan_id", "1"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.settings", "network default"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l3_firewall_rules.0.comment", "Allow TCP traffic to subnet with HTTP servers."),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l3_firewall_rules.0.policy", "allow"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l3_firewall_rules.0.protocol", "tcp"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l3_firewall_rules.0.dest_port", "443"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l3_firewall_rules.0.dest_cidr", "192.168.1.0/24"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.0.policy", "deny"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.0.type", "host"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.0.value", "google.com"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.1.policy", "deny"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.1.type", "ipRange"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.1.value", "10.11.12.00/24"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.2.policy", "deny"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.2.type", "ipRange"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.2.value", "10.11.12.00/24:5555"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.3.policy", "deny"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.firewall_and_traffic_shaping.l7_firewall_rules.3.type", "port"),
					...
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.friday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.friday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.friday.to", "17:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.saturday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.saturday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.saturday.to", "17:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.sunday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.sunday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.sunday.to", "17:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.monday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.monday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.monday.to", "17:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.tuesday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.tuesday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.tuesday.to", "17:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.wednesday.active", "true"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.wednesday.from", "09:00"),
					resource.TestCheckResourceAttr("data.meraki_network_group_policys.test", "list.0.scheduling.wednesday.to", "17:00"),
